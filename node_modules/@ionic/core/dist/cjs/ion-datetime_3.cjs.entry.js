...
const parse = require('./parse-5dc85832.js');
...
const Datetime = class {
  constructor(hostRef) {
    ...
    this.processValue = (value) => {
      ...
      let valueToProcess = parse.parseDate(value !== null && value !== void 0 ? value : parse.getToday());
  ...
  renderCombinedDatePickerColumn() {
    ...
    lastMonth.day = parse.getNumDaysInMonth(lastMonth.month, lastMonth.year);
    /**
     ...
     * constraints.
     */
    const min = minParts !== undefined && parse.isAfter(minParts, monthsToRender[0]) ? minParts : monthsToRender[0];
    const max = maxParts !== undefined && parse.isBefore(maxParts, lastMonth) ? maxParts : lastMonth;
  ...
  renderDayPickerColumn(days) {
    ...
    return (index.h("ion-picker-column-internal", { class: "day-column", color: this.color, items: days, value: (_a = (workingParts.day !== null ? workingParts.day : this.todayParts.day)) !== null && _a !== void 0 ? _a : undefined, onIonChange: (ev) => {
        // TODO(FW-1823) Remove this when iOS 14 support is dropped.
        // Due to a Safari 14 issue we need to destroy
        // the scroll listener before we update state
        // and trigger a re-render.
  ...
  renderTimePickerColumns(forcePresentation) {
    ...
    const { hoursData, minutesData, dayPeriodData } = parse.getTimeColumnsData(this.locale, this.workingParts, this.hourCycle, valueIsDefined ? this.minParts : undefined, valueIsDefined ? this.maxParts : undefined, this.parsedHourValues, this.parsedMinuteValues);
    return [
  ...
  renderTimeOverlay() {
    ...
    return [
      ...
      index.h("button", { class: {
        ...
        } }, parse.getLocalizedTime(this.locale, activePart, use24Hour)),
  ...
  renderCalendarViewHeader() {
    ...
    if (isArray && activeParts.length !== 1) {
      ...
      if (titleSelectedDatesFormatter !== undefined) {
        try {
          headerText = titleSelectedDatesFormatter(parse.convertDataToISO(activeParts));
        }
        catch (e) {
      ...
      headerText = parse.getMonthAndDay(this.locale, this.getDefaultPart());
    }
    return (index.h("div", { class: "datetime-header" }, index.h("div", { class: "datetime-title" }, index.h("slot", { name: "title" }, "Select Date")), index.h("div", { class: "datetime-selected-date" }, headerText)));
  }
  /**
